<div align="center">
  ...
  <p>
    <img alt="version" src="https://img.shields.io/badge/version-1.3.0-0e639c">
...
它强调开箱即用的本地开发体验：编辑、编译、运行、终端、文件树、查找替换等功能集成在同一个桌面应用里。

## 功能特性

- 使用 Monaco Editor 编辑 C / C++ 源文件与头文件
- 基于 GCC / g++（MinGW）完成编译与运行
- 一键代码格式化（基于 clang-format，LLVM 风格，支持右键菜单与 Shift + Alt + F）
- 集成输出面板与交互终端
- 支持文件树浏览、创建、重命名、删除与资源管理器定位
- 支持拖拽打开文件、拖拽打开项目、拖拽复制文件到项目
- 支持查找 / 替换
- 支持中文路径下的编译与运行
- 内置便携 MinGW 工具链，安装后开箱即用，无需自行配置编译器
...
1. 前往 GitHub Releases 下载最新安装包并安装。
2. 启动应用后即可使用，无需额外配置。
